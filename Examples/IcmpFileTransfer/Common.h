...
/**
 * Read and parse the command line arguments from the user. If arguments are
 * wrong or parsing fails the method causes the program to exit
 */
void readCommandLineArguments(int argc, char* argv[],
                              ...
                              std::string& fileNameToSend, int& packetPerSec,
                              size_t& blockSize);

/**
 * Send an ICMP request from source to dest with certain ICMP ID, msgType will
 * be written in the timestamp field of the request, and data will be written in
...
/**
 * Send an ICMP reply from source to dest with certain ICMP ID, msgType will be
 * written in the timestamp field of the request, and data will be written in
 * the data section of the request
 */
 ...
 * for example: for the input '/home/myuser/mypcap.pcap' -> return value will be
 * 'mypcap.pcap'
 */
