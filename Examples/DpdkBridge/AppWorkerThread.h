...
/**
 * The worker thread class which does all the work. It's initialized with
 * pointers to the RX and TX devices, then it runs in an endless loop which
 * reads packets from the RX device and sends them to the TX device. The endless
