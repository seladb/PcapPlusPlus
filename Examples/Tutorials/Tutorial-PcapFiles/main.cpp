...
int main(int argc, char* argv[]) {
    ...
    // create a pcap file writer. Specify file name and link type of all packets
    ...
    // create a pcap-ng file writer. Specify file name. Link type is not necessary
    ...
    std::cout << "Written " << stats.packetsRecv
              << " packets successfully to pcap writer and " << stats.packetsDrop
              << " packets could not be written" << std::endl;

    // read stats from pcap-ng writer and print them
    pcapNgWriter.getStatistics(stats);
    std::cout << "Written " << stats.packetsRecv
              << " packets successfully to pcap-ng writer and "
    ...
    // free reader memory because it was created by
