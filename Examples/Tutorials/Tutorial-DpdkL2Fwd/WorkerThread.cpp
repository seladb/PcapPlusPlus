...
L2FwdWorkerThread::L2FwdWorkerThread(pcpp::DpdkDevice* rxDevice,
...
void L2FwdWorkerThread::stop() { m_Stop = true; }

uint32_t L2FwdWorkerThread::getCoreId() const { return m_CoreId; }
