...
struct AppWorkerConfig {
    ...
    AppWorkerConfig()
        : CoreId(MAX_NUM_OF_CORES + 1), SendPacketsTo(NULL),
...
struct PacketStats {
  public:
    ...
    PacketStats()
        : WorkerId(MAX_NUM_OF_CORES + 1), PacketCount(0), EthCount(0),
          ArpCount(0), Ip4Count(0), Ip6Count(0), TcpCount(0), UdpCount(0),
