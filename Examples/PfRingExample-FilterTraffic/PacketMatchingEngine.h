...
/**
 * Responsible for matching packets by match criteria received from the user.
 * Current match criteria are a combination of zero or more of the following
...
class PacketMatchingEngine
{
  ...
  public:
    PacketMatchingEngine(const pcpp::IPv4Address& srcIpToMatch,
                         const pcpp::IPv4Address& dstIpToMatch,
                         uint16_t srcPortToMatch, uint16_t dstPortToMatch,
                         pcpp::ProtocolType protocolToMatch)
