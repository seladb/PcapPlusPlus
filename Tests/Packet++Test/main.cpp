...
PTF_TEST_CASE(DhcpCreationTest)
{
	...
	dhcpLayer.setYourIpAddress(pcpp::experimental::IPv4Address("10.10.8.235"));
	dhcpLayer.setServerIpAddress(pcpp::experimental::IPv4Address("172.22.178.234"));
	dhcpLayer.setGatewayIpAddress(pcpp::experimental::IPv4Address("10.10.8.240"));
