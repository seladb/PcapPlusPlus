...
int main(int argc, char* argv[])
{
	...
	PTF_RUN_TEST(SctpDataChunkParsingTest, "sctp");
	PTF_RUN_TEST(SctpSackChunkParsingTest, "sctp");
	PTF_RUN_TEST(SctpMultipleChunksTest, "sctp");
	PTF_RUN_TEST(SctpChecksumTest, "sctp");
	PTF_RUN_TEST(SctpValidationTest, "sctp");
	PTF_RUN_TEST(SctpChunkTypesTest, "sctp");
	PTF_RUN_TEST(SctpShutdownChunkTest, "sctp");
	PTF_RUN_TEST(SctpForwardTsnChunkTest, "sctp");
	PTF_RUN_TEST(SctpIForwardTsnChunkTest, "sctp");
	PTF_RUN_TEST(SctpHeartbeatChunkTest, "sctp");
	PTF_RUN_TEST(SctpCookieEchoChunkTest, "sctp");
	PTF_RUN_TEST(SctpAuthChunkTest, "sctp");
	PTF_RUN_TEST(SctpIDataChunkTest, "sctp");
	PTF_RUN_TEST(SctpEcneCwrChunkTest, "sctp");
	PTF_RUN_TEST(SctpCwrChunkTest, "sctp");
	PTF_RUN_TEST(SctpAbortChunkTest, "sctp");
	PTF_RUN_TEST(SctpErrorChunkTest, "sctp");
	PTF_RUN_TEST(SctpOverIPv6Test, "sctp");
	PTF_RUN_TEST(SctpAsconfChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddDataChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddInitChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddInitAckChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddSackChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddHeartbeatChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddShutdownChunksTest, "sctp");
	PTF_RUN_TEST(SctpAddAbortChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddCookieChunksTest, "sctp");
	PTF_RUN_TEST(SctpAddErrorChunkTest, "sctp");
	PTF_RUN_TEST(SctpMultipleChunkCreationTest, "sctp");
	PTF_RUN_TEST(SctpInitParameterIteratorTest, "sctp");
	PTF_RUN_TEST(SctpInitParameterIPv6Test, "sctp");
	PTF_RUN_TEST(SctpChunkPaddingTest, "sctp");
	PTF_RUN_TEST(SctpBundlingValidationTest, "sctp");
	PTF_RUN_TEST(SctpAddEcneCwrChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddForwardTsnChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddIDataChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddIForwardTsnChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddPadChunkTest, "sctp");
	PTF_RUN_TEST(SctpErrorCauseIteratorTest, "sctp");
	PTF_RUN_TEST(SctpStateCookieParameterTest, "sctp");
	PTF_RUN_TEST(SctpHostNameAddressDetectionTest, "sctp");
	PTF_RUN_TEST(SctpAuthParametersTest, "sctp");
	PTF_RUN_TEST(SctpAddAuthChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddAsconfChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddAsconfAckChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddReconfigChunkTest, "sctp");
	PTF_RUN_TEST(SctpReconfigParameterIteratorTest, "sctp");
	PTF_RUN_TEST(SctpReconfigResponseTest, "sctp");
	PTF_RUN_TEST(SctpAsconfParameterIteratorTest, "sctp");
	PTF_RUN_TEST(SctpZeroChecksumParameterTest, "sctp");
	PTF_RUN_TEST(SctpAdditionalErrorCauseAccessorsTest, "sctp");
	PTF_RUN_TEST(SctpUnrecognizedChunkErrorTest, "sctp");
	PTF_RUN_TEST(SctpExtendedPpidEnumsTest, "sctp");
	PTF_RUN_TEST(SctpReconfigResultEnumsTest, "sctp");
	PTF_RUN_TEST(SctpEdmidEnumsTest, "sctp");
	PTF_RUN_TEST(SctpNrSackChunkParsingTest, "sctp");
	PTF_RUN_TEST(SctpAddNrSackChunkTest, "sctp");
	PTF_RUN_TEST(SctpAddNrSackChunkMinimalTest, "sctp");
	PTF_RUN_TEST(SctpHmacSha1ComputationTest, "sctp");
	PTF_RUN_TEST(SctpHmacSha256ComputationTest, "sctp");
	PTF_RUN_TEST(SctpHmacVerificationTest, "sctp");
	PTF_RUN_TEST(SctpHmacSizeConstantsTest, "sctp");
	PTF_RUN_TEST(SctpExtendedPpidEnumsNewTest, "sctp");
	PTF_RUN_TEST(SctpNrSackChunkTypeNameTest, "sctp");
	PTF_RUN_TEST(SctpChunkActionBitsTest, "sctp");
	PTF_RUN_TEST(SctpParamActionBitsTest, "sctp");
	PTF_RUN_TEST(SctpComputeAuthHmacTest, "sctp");
