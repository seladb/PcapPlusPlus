...
int main(int argc, char* argv[])
{
	...
	PTF_RUN_TEST(DoIpRoutingActivationRequestPacketParsing, "doip");
	PTF_RUN_TEST(DoIpRoutingActivationRequestPacketCreation, "doip");
	PTF_RUN_TEST(DoIpRoutingActivationResponsePacketParsing, "doip");
	...
	PTF_RUN_TEST(DoIpVehicleIdentificationRequestWithEIDPacketParsing, "doip");
	PTF_RUN_TEST(DoIpVehicleIdentificationRequestWithEIDPacketCreation, "doip");
	PTF_RUN_TEST(DoIpVehicleIdentificationRequestWithVINPacketParsing, "doip");
	PTF_RUN_TEST(DoIpVehicleIdentificationRequestWithVINPacketCreation, "doip");
	PTF_RUN_TEST(DoIpVehicleAnnouncementMessagePacketParsing, "doip");
	PTF_RUN_TEST(DoIpVehicleAnnouncementMessagePacketCreation, "doip");
	...
	PTF_RUN_TEST(DoIpDiagnosticMessagePacketCreation, "doip");
	PTF_RUN_TEST(DoIpDiagnosticMessageAckPacketParsing, "doip");
	PTF_RUN_TEST(DoIpDiagnosticMessageAckPacketCreation, "doip");
	PTF_RUN_TEST(DoIpDiagnosticMessageNackPacketParsing, "doip");
	PTF_RUN_TEST(DoIpDiagnosticMessageNackPacketCreation, "doip");
