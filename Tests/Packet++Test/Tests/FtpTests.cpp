...
PTF_TEST_CASE(FtpParsingTests)
{
	...
	std::vector<std::pair<pcpp::FtpRequestLayer::FtpCommand, std::string>> possibleCommandCodes = {
		...
		{ pcpp::FtpRequestLayer::FtpCommand::MLST,           "Provides data about exactly the object named on its command line "
		...
		{ pcpp::FtpRequestLayer::FtpCommand::PWD,
		...
		{ pcpp::FtpRequestLayer::FtpCommand::STOR,
	...
	std::vector<std::pair<pcpp::FtpResponseLayer::FtpStatusCode, std::string>> possibleStatusCodes = {
		...
		{ pcpp::FtpResponseLayer::FtpStatusCode::DATA_OPEN_NO_TRANSFER,
