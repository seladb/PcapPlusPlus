...
PTF_TEST_CASE(X509ParsingTest)
{
	...
	auto cert = pcpp::X509Certificate::decode(data, dataLen);
	...
	for (const auto& component : cert->getTbsCertificate().getIssuer().getComponents())
	{
		std::cout << "  Type: " << component.getType().toString() << ", Value: " << component.getValue() << std::endl;
	}
	std::cout << "Validity: " << std::endl;
	std::cout << "  Not Before: " << cert->getTbsCertificate().getValidity().getNotBeforeValue() << std::endl;
	std::cout << "  Not After: " << cert->getTbsCertificate().getValidity().getNotAfterValue() << std::endl;
	std::cout << "Subject: " << std::endl;
	for (const auto& component : cert->getTbsCertificate().getSubject().getComponents())
	{
		std::cout << "  Type: " << component.getType().toString() << ", Value: " << component.getValue() << std::endl;
	}
	...
	std::cout << "  Subject Public Key: " << subjectPublicKeyInfo.getSubjectPublicKey() << std::endl;
	...
	std::cout << "Signature: " << cert->getSignature() << std::endl;
}
