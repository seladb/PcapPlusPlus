...
PTF_TEST_CASE(X509ParsingTest)
{
	...
	PTF_ASSERT_EQUAL(std::chrono::duration_cast<std::chrono::microseconds>(x509Certificate->getNotBefore().getTimestamp().time_since_epoch()).count(), 1748738743000000);
	PTF_ASSERT_EQUAL(x509Certificate->getNotAfter().toString(), "2025-08-30 01:45:39");
	PTF_ASSERT_EQUAL(std::chrono::duration_cast<std::chrono::microseconds>(x509Certificate->getNotAfter().getTimestamp().time_since_epoch()).count(), 1756518339000000);
	...
	PTF_ASSERT_EQUAL(x509Certificate->getPublicKey().toString(), "04:1b:6f:da:7f:7d:ec:43:96:ae:83:17:01:f7:92:ce:0a:18:50:18:73:9f:e4:27:5b:4b:d4:b6:42:b8:9c:01:32:94:31:d3:69:f4:2d:ca:9e:b9:86:35:53:20:6a:d9:45:e6:03:13:0c:fd:94:51:55:21:84:06:6f:df:5b:b9:99");

	PTF_ASSERT_EQUAL(x509Certificate->getSignatureAlgorithm(), pcpp::X509Algorithm::ECDSAWithSHA256, enum);
	PTF_ASSERT_EQUAL(x509Certificate->getSignature().toString(), "30:46:02:21:00:df:06:da:82:75:83:9e:65:db:92:d8:a1:7b:5e:3c:8d:e8:d6:61:e9:39:ce:2e:e5:59:92:f3:8f:0a:4f:43:f5:02:21:00:8f:df:13:b1:a5:e0:10:f5:e1:7b:86:96:50:7d:a8:63:dd:18:67:d4:7e:94:f2:1b:a6:40:c6:e9:60:76:11:60");

	PTF_ASSERT_EQUAL(x509Certificate->getExtensionCount(), 10);
	std::vector<pcpp::X509ExtensionType> existingExtensionTypes = {pcpp::X509ExtensionType::KeyUsage, pcpp::X509ExtensionType::ExtendedKeyUsage, pcpp::X509ExtensionType::BasicConstraints, pcpp::X509ExtensionType::SubjectKeyIdentifier, pcpp::X509ExtensionType::AuthorityKeyIdentifier, pcpp::X509ExtensionType::AuthorityInfoAccess, pcpp::X509ExtensionType::SubjectAltName, pcpp::X509ExtensionType::CertificatePolicies, pcpp::X509ExtensionType::CrlDistributionPoints, pcpp::X509ExtensionType::CTPrecertificateSCTs};
	for (const auto& extensionType : existingExtensionTypes)
	{
		PTF_ASSERT_TRUE(x509Certificate->hasExtension(extensionType));
	}
	std::vector<pcpp::X509ExtensionType> missingExtensionTypes = {pcpp::X509ExtensionType::IssuerAltName, pcpp::X509ExtensionType::PolicyMappings, pcpp::X509ExtensionType::PolicyConstraints};
	for (const auto& extensionType : missingExtensionTypes)
	{
		PTF_ASSERT_FALSE(x509Certificate->hasExtension(extensionType));
	}

	std::string expectedJson = "{\"version\":3,\"serialNumber\":\"8f:7c:fe:10:9e:fa:98:7f:11:68:12:e1:98:00:84:97\",\"issuer\":\"C=US, O=Google Trust Services, CN=WE1\",\"validity\":{\"notBefore\":\"2025-06-01 00:45:43\",\"notAfter\":\"2025-08-30 01:45:39\"},\"subject\":\"CN=chatgpt.com\",\"subjectPublicKeyInfo\":{\"subjectPublicKeyAlgorithm\":\"ECDSA\",\"subjectPublicKey\":\"04:1b:6f:da:7f:7d:ec:43:96:ae:83:17:01:f7:92:ce:0a:18:50:18:73:9f:e4:27:5b:4b:d4:b6:42:b8:9c:01:32:94:31:d3:69:f4:2d:ca:9e:b9:86:35:53:20:6a:d9:45:e6:03:13:0c:fd:94:51:55:21:84:06:6f:df:5b:b9:99\"},\"extensions\":10,\"signatureAlgorithm\":\"ECDSAWithSHA256\",\"signature\":\"30:46:02:21:00:df:06:da:82:75:83:9e:65:db:92:d8:a1:7b:5e:3c:8d:e8:d6:61:e9:39:ce:2e:e5:59:92:f3:8f:0a:4f:43:f5:02:21:00:8f:df:13:b1:a5:e0:10:f5:e1:7b:86:96:50:7d:a8:63:dd:18:67:d4:7e:94:f2:1b:a6:40:c6:e9:60:76:11:60\"}";
...
PTF_TEST_CASE(X509VariantsParsingTest)
{
	// Multiple RDNs
	{
		...
		std::string rdnsAsString = "C=US, ST=California, L=San Francisco, O=ExampleOrg, OU=DevOps, CN=example.com, E=admin@example.com, SERIALNUMBER=123456789, T=Engineer, G=John, SN=Doe, Initials=JD, Pseudonym=jdoe, GENERATION=Jr, dnQualifier=qualifier, postalCode=94105, STREET=1234 Example Street, businessCategory=IT, Unknown=UID12345, DC=example.com";
