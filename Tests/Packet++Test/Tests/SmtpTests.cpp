...
PTF_TEST_CASE(SmtpParsingTests)
{
	...
	std::vector<std::pair<pcpp::SmtpResponseLayer::SmtpStatusCode, std::string>> possibleStatusCodes = {
		...
		{pcpp::SmtpResponseLayer::SmtpStatusCode::TEMP_AUTH_FAILED, "Temporary authenticaion failed"},
		{pcpp::SmtpResponseLayer::SmtpStatusCode::PARAM_NOT_ACCOMODATED, "Server unable to accomodate parameters"},
