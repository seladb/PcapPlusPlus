...
PTF_TEST_CASE(IgmpCreateAndEditTest)
{
	...
	PTF_ASSERT_EQUAL(igmpv1Packet.getRawPacket()->getRawDataLen(), bufferLength1-14, num);
	PTF_ASSERT_BUF_COMPARE(igmpv1Packet.getRawPacket()->getRawData(), buffer1, igmpv1Packet.getRawPacket()->getRawDataLen());

	PTF_ASSERT_EQUAL(igmpv2Packet.getRawPacket()->getRawDataLen(), bufferLength2-14, num);
...
PTF_TEST_CASE(Igmpv3ParsingTest)
{
	...
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getIgmpV3QueryHeader()->s_qrv, 0x0f, num);
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getSourceAddressCount(), 1, num);
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getHeaderLen(), 16, num);
	...
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getSourceAddressCount(), 100, num);
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getHeaderLen(), 16, num);
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getSourceAddressAtIndex(0).toString(), "192.168.20.222", string);
	PTF_ASSERT_EQUAL(igmpv3QueryLayer->getSourceAddressAtIndex(1).toString(), "0.0.0.0", string);
	...
	PTF_ASSERT_EQUAL(igmpv3ReportLayer->getGroupRecordCount(), 1, num);
	PTF_ASSERT_EQUAL(igmpv3ReportLayer->getHeaderLen(), 20, num);
	pcpp::igmpv3_group_record* curGroup = igmpv3ReportLayer->getFirstGroupRecord();
	PTF_ASSERT_NOT_NULL(curGroup);
	PTF_ASSERT_EQUAL(curGroup->recordType, 1, num);
	PTF_ASSERT_EQUAL(curGroup->getMulticastAddress().toString(), "224.0.0.9", string);
	PTF_ASSERT_EQUAL(curGroup->getSourceAddressCount(), 1, num);
	PTF_ASSERT_EQUAL(curGroup->getRecordLen(), 12, num);
...
PTF_TEST_CASE(Igmpv3QueryCreateAndEditTest)
{
	...
	PTF_ASSERT_EQUAL(igmpv3QueryPacket.getRawPacket()->getRawDataLen(), bufferLength1, num);
	...
	PTF_ASSERT_EQUAL(igmpv3QueryPacket.getRawPacket()->getRawDataLen(), bufferLength2, num);
...
PTF_TEST_CASE(Igmpv3ReportCreateAndEditTest)
{
	...
	PTF_ASSERT_NOT_NULL(groupRec);
	PTF_ASSERT_EQUAL(groupRec->getSourceAddressCount(), 3, num);
	...
	PTF_ASSERT_NOT_NULL(groupRec);
	PTF_ASSERT_EQUAL(groupRec->getRecordLen(), 24, num);
	...
	PTF_ASSERT_EQUAL(igmpv3ReportPacket.getRawPacket()->getRawDataLen(), bufferLength1, num);
	...
	PTF_ASSERT_EQUAL(igmpv3ReportPacket.getRawPacket()->getRawDataLen(), bufferLength2, num);
