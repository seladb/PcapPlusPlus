...
PTF_TEST_CASE(SipRequestLayerParsingTest)
{
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFirstLine()->getSize(), 47, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFieldCount(), 9, num);

	PTF_ASSERT_EQUAL(sipReqLayer->getFirstField()->getFieldName(), "Via", string);

	PTF_ASSERT_EQUAL(sipReqLayer->getHeaderLen(), 469, num);
	PTF_ASSERT_EQUAL(sipReqLayer->getLayerPayloadSize(), 229, num);
	PTF_ASSERT_EQUAL(sipReqLayer->getContentLength(), 229, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFirstLine()->getSize(), 35, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFirstLine()->getSize(), 38, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getContentLength(), 0, num);
	PTF_ASSERT_EQUAL(sipReqLayer->getFieldCount(), 9, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFirstLine()->getSize(), 37, num);
	...
	PTF_ASSERT_EQUAL(sipReqLayer->getFieldCount(), 11, num);
...
PTF_TEST_CASE(SipRequestLayerCreationTest)
{
	...
	PTF_ASSERT_EQUAL(newSipPacket.getRawPacket()->getRawDataLen(), bufferLength1, num);
...
PTF_TEST_CASE(SipRequestLayerEditTest)
{
	...
	PTF_ASSERT_EQUAL(secondSipReqLayer->getHeaderLen(), sipReqLayer->getHeaderLen(), num);
	PTF_ASSERT_EQUAL(secondSipReqLayer->getFirstLine()->getSize(), sipReqLayer->getFirstLine()->getSize(), num);
	...
	PTF_ASSERT_EQUAL(secondSipReqLayer->getFieldCount(), sipReqLayer->getFieldCount(), num);
...
PTF_TEST_CASE(SipResponseLayerParsingTest)
{
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeAsInt(), 100, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 20, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getContentLength(), 0, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeAsInt(), 180, num);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeString(), "Ringing", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getVersion(), "SIP/2.0", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 21, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeAsInt(), 200, num);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeString(), "Ok", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getVersion(), "SIP/2.0", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 16, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getContentLength(), 298, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeAsInt(), 401, num);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeString(), "Unauthorized", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getVersion(), "SIP/2.0", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 26, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeAsInt(), 503, num);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCodeString(), "Service Unavailable", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getVersion(), "SIP/2.0", string);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 33, num);
...
PTF_TEST_CASE(SipResponseLayerCreationTest)
{
	...
	PTF_ASSERT_EQUAL(newSipPacket.getRawPacket()->getRawDataLen(), bufferLength6, num);
...
PTF_TEST_CASE(SipResponseLayerEditTest)
{
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 22, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 36, num);
	...
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getStatusCode(), pcpp::SipResponseLayer::Sip603Decline, enum);
	PTF_ASSERT_EQUAL(sipRespLayer->getFirstLine()->getSize(), 31, num);
	...
	PTF_ASSERT_EQUAL(secondSipRespLayer->getHeaderLen(), sipRespLayer->getHeaderLen(), num);
	PTF_ASSERT_EQUAL(secondSipRespLayer->getFirstLine()->getSize(), sipRespLayer->getFirstLine()->getSize(), num);
	PTF_ASSERT_EQUAL(secondSipRespLayer->getFirstLine()->getStatusCode(), sipRespLayer->getFirstLine()->getStatusCode(), enum);
	PTF_ASSERT_EQUAL(secondSipRespLayer->getFieldCount(), sipRespLayer->getFieldCount(), num);
...
PTF_TEST_CASE(SdpLayerParsingTest)
{
	...
	PTF_ASSERT_EQUAL(sdpLayer->getFieldCount(), 11, num);
	...
	PTF_ASSERT_EQUAL(sdpLayer->getMediaPort("audio"), 40376, num);

	PTF_ASSERT_TRUE(sdpPacket2.isPacketOfType(pcpp::SDP));
	sdpLayer = sdpPacket2.getLayerOfType<pcpp::SdpLayer>();
	PTF_ASSERT_NOT_NULL(sdpLayer);

	PTF_ASSERT_EQUAL(sdpLayer->getFieldCount(), 18, num);
	...
	PTF_ASSERT_EQUAL(sdpLayer->getMediaPort("audio"), 6010, num);
	PTF_ASSERT_EQUAL(sdpLayer->getMediaPort("image"), 6012, num);
} // SdpLayerParsingTest
...
PTF_TEST_CASE(SdpLayerCreationTest)
{
	...
	PTF_ASSERT_EQUAL(sdpLayerPtr->getFieldCount(), 18, num);
	PTF_ASSERT_EQUAL(sdpLayerPtr->getHeaderLen(), 406, num);
	...
	PTF_ASSERT_EQUAL(copiedSdpLayer.getFieldCount(), 18, num);
	PTF_ASSERT_EQUAL(copiedSdpLayer.getHeaderLen(), 406, num);
...
PTF_TEST_CASE(SdpLayerEditTest)
{
	...
	PTF_ASSERT_EQUAL(sdpLayer->getFieldCount(), targetSdpLayer->getFieldCount(), num);
	PTF_ASSERT_EQUAL(sdpLayer->getHeaderLen(), targetSdpLayer->getHeaderLen(), num);
	PTF_ASSERT_EQUAL(sdpLayer->getOwnerIPv4Address(), targetSdpLayer->getOwnerIPv4Address(), object);
	PTF_ASSERT_EQUAL(sdpLayer->getMediaPort("audio"), targetSdpLayer->getMediaPort("audio"), num);
	PTF_ASSERT_EQUAL(sdpLayer->getMediaPort("image"), targetSdpLayer->getMediaPort("image"), num);
