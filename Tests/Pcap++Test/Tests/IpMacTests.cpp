...
PTF_TEST_CASE(TestIPAddress)
{
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Address("invalid"), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Address("321.123.1000.1"), std::invalid_argument, "Not a valid IPv4 address");
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Address("invalid"), std::invalid_argument, "Not a valid IPv6 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Address("zzzz:2222:1002:0051:0000:0000:0000:0004"), std::invalid_argument, "Not a valid IPv6 address");
...
PTF_TEST_CASE(TestMacAddress)
{
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress{invalidCharArrayAddress}, std::invalid_argument, "Invalid MAC address format, should be xx:xx:xx:xx:xx:xx");
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress({ 0xBB, 0xBB, 0xBB, 0xBB, 0xBB }), std::invalid_argument, "Invalid initializer list size, should be 6");
	#endif
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress("aa:aa:aa:aa:aa:aa:bb:bb:bb:bb"), std::invalid_argument, "Invalid MAC address format, should be xx:xx:xx:xx:xx:xx");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress("aa:aa:aa"), std::invalid_argument, "Invalid MAC address format, should be xx:xx:xx:xx:xx:xx");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress("aa:aa:aa:ZZ:aa:aa"), std::invalid_argument, "Invalid MAC address format, should be xx:xx:xx:xx:xx:xx");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::MacAddress("aa:aa:aa:aa:aa:aa:"), std::invalid_argument, "Invalid MAC address format, should be xx:xx:xx:xx:xx:xx");
} // TestMacAddress
...
PTF_TEST_CASE(TestIPv4Network)
{
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("invalid"), 1), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), -1), std::invalid_argument, "prefixLen must be an integer between 0 and 32");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), 33), std::invalid_argument, "prefixLen must be an integer between 0 and 32");

	// Invalid c'tor: IPv4 address + netmask
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("invalid"), "255.255.0.0"), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "invalid"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "999.999.999.999"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "255.255.0.255"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "10.10.10.10"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "0.255.255.255"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(pcpp::IPv4Address("1.1.1.1"), "127.255.255.255"), std::invalid_argument, "netmask is not valid");

	// Invalid c'tor: address + netmask in one string
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("invalid")), std::invalid_argument, "The input should be in the format of <address>/<netmask> or <address>/<prefixLength>");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("invalid/255.255.255.0")), std::invalid_argument, "The input doesn't contain a valid IPv4 network prefix: Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/255.255.255.0/24")), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/33")), std::invalid_argument, "Prefix length must be an integer between 0 and 32");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/-1")), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/invalid")), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/999.999.999.999")), std::invalid_argument, "Not a valid IPv4 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/255.255.0.1")), std::invalid_argument, "Netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv4Network(std::string("1.1.1.1/0.0.255.255")), std::invalid_argument, "Netmask is not valid");
...
PTF_TEST_CASE(TestIPv6Network)
{
	...
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("invalid"), 1), std::invalid_argument, "Not a valid IPv6 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), 129), std::invalid_argument, "prefixLen must be an integer between 0 and 128");

	// Invalid c'tor: IPv6 address + netmask
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("invalid"), "ffff::"), std::invalid_argument, "Not a valid IPv6 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "invalid"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "ffff:ff10::"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "ffff:ee00::"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "7f00::"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "ffff::ffff"), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(pcpp::IPv6Address("2001:db8::"), "f000::0001"), std::invalid_argument, "netmask is not valid");

	// Invalid c'tor: address + netmask in one string
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("invalid")), std::invalid_argument, "The input should be in the format of <address>/<netmask> or <address>/<prefixLength>");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("invalid/32")), std::invalid_argument, "The input doesn't contain a valid IPv6 network prefix: Not a valid IPv6 address");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/32/24")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/255.255.0.0")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/130")), std::invalid_argument, "Prefix length must be an integer between 0 and 128");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/-1")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/invalid")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/a2cb:d625::")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/ffff::0001")), std::invalid_argument, "netmask is not valid");
	PTF_ASSERT_RAISE_INCLUDES(pcpp::IPv6Network(std::string("ef3c:7157:a084:23c0::/0fff::")), std::invalid_argument, "netmask is not valid");
	...
	for (auto netmaskPrefixLenAndNetPrefix : netmasksPrefixLensAndNetPrefix)
	{
		...
		{
			PTF_ASSERT_RAISE_INCLUDES(iPv6NetworkD.getTotalAddressCount(), std::out_of_range, "Number of addresses exceeds uint64_t");
		}
	}
...
PTF_TEST_CASE(TestIPNetwork)
{
	...
	for (auto networkInfo : networkInfos)
	{
		...
		{
			PTF_ASSERT_RAISE_INCLUDES(networkD.getTotalAddressCount(), std::out_of_range, "Number of addresses exceeds uint64_t");
		}
	}
