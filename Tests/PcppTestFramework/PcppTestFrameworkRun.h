...
#define PTF_RUN_TEST(TestName, tags)                                                                                   \
	...
	{                                                                                                                  \
		if (showSkippedTests)                                                                                          \
		{                                                                                                              \
			std::cout << std::left << std::setw(PTF_TESTNAME_WIDTH) << #TestName << ": SKIPPED (tags don't match)" << std::endl;       \
		}                                                                                                              \
	...
	{                                                                                                                  \
		...
		{                                                                                                              \
			...
			std::cout << std::left << std::setw(PTF_TESTNAME_WIDTH) << #TestName << ": FAILED. Unhandled exception occurred! "         \
		...
		{                                                                                                              \
			...
			{                                                                                                          \
				...
				{                                                                                                      \
					TestName##_result = PTF_RESULT_FAILED;                                                             \
					std::cout << std::left << std::setw(PTF_TESTNAME_WIDTH) << #TestName << ": FAILED. Memory leak found! "            \
