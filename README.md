...
30. SSL/TLS - parsing only (no editing capabilities)
...
34. DNS
35. FTP
36. HTTP headers (request & response)
37. NTP (v3, v4)
38. Radius
39. SOME/IP
40. SSH - parsing only (no editing capabilities)
41. Telnet - parsing only (no editing capabilities)
42. Generic payload
