...
class UdpLayer : public Layer {
   ...
   */
    ...
    /**
   * A constructor that allocates a new UDP header with source and destination
   * ports
   ...
   */
    ...
    /**
   * Get a pointer to the UDP header. Notice this points directly to the data,
   ...
   */
    ...
    /**
   * Currently identifies the following next layers: DnsLayer, DhcpLayer,
   * VxlanLayer, SipRequestLayer, SipResponseLayer, RadiusLayer. Otherwise sets
   * PayloadLayer
   */
    void parseNextLayer();
