...
#pragma pack(pop)
	...
	{
	public:
		static bool isL2TPPort(uint16_t port) { return port == 1701 ; }
		void ToStructuredOutput(std::ostream &os) const;
		
		l2tphdr_base* getL2tpHeader() {	return m_header;}
	...
	private:
		...
		bool isControlMessage() const{	return isFieldTrue(L2tpTypeBit);	}
		bool isDataMessage() const {	return !isFieldTrue(L2tpTypeBit);	}
	};
