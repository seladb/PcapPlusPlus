...
#define PCPP_TCPOLEN_EXP_MIN 2
	...
	public:
		 ...
		 * @return An TcpOption object that contains the first option that matches this type, or logical nullptr
		 ...
		 * contain a logical nullptr (TcpOption#isNull() == true)
		 */
		 ...
		 * returned value will contain a logical nullptr (TcpOption#isNull() == true)
		 * @param[in] tcpOption A TCP option object that exists in the current layer
		 * @return A TcpOption object that contains the TCP option data that comes next, or logical nullptr if the given
		 * TCP option: (1) was the last one; or (2) contains a logical nullptr; or (3) doesn't belong to this packet
		 */
		 ...
		 * @return A TcpOption object that contains the newly added TCP option data or logical nullptr
		 ...
		 * @return A TcpOption object containing the newly inserted TCP option data or logical nullptr
