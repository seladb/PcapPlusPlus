...
class TpktLayer : public Layer
{
   ...
   */
    ...
    /**
   * Currently parses the rest of the packet as a COTP protocol or generic
   ...
   * associated with the TPKT protocol
   ...
   */
    ...
    /**
   * A static method that takes a byte array and detects whether it is a TPKT
   * message
   ...
   * other methods of this layer. Notice the return value points directly to the
