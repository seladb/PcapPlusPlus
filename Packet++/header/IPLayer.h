 ...
 * and IPv6Layer). It provides methods to fetch the source and destination IP
 * addresses in an abdtract way that hides the IP type (IPv4 or IPv6). This is
 * useful for use-cases in which the IP type doesn't matter. For example: if
