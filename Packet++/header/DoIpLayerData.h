...
#define DOIP_RESERVED_OEM_LEN 4
	...
	/// @class AliveCheckRequestData
	/// @brief Represents an alive check request  in DoIP.
	class AliveCheckRequestData : public IDoIpMessageData
	{
	public:
		/// @brief Default constructor for the AliveCheckRequestData class.
		///
		/// Initializes a `AliveCheckRequestData` instance
		/// ensuring compliance with the DoIP protocol requirements.
		AliveCheckRequestData();
		...
		/// @brief Retrieves the raw binary data of the message.
		/// @return An empty vector of bytes representing the message data.
		std::vector<uint8_t> getData() const override;
	...
	public:
		...
		/// @brief Converts the message data to a human-readable string.
		/// @return An empty string because the Alive check request message has no additional data.
		std::string toString() const override;
	...
	{
	public:
		/// @brief Default constructor for the VehicleIdentificationRequestData class.
		///
		/// Initializes a `VehicleIdentificationRequest` instance
		/// ensuring compliance with the DoIP protocol requirements.
		VehicleIdentificationRequestData();
		...
		/// @brief Converts the message data to a human-readable string.
		/// @return An empty string because Vehicle identification request message has no additional data.
		std::string toString() const override;
