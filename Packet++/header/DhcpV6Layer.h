...
namespace pcpp
{
	...
	public:
		 ...
		 * a logical nullptr (DhcpV6Option#isNull() == true)
		 */
		 ...
		 * returned value will contain a logical nullptr (DhcpV6Option#isNull() == true)
		 * @param[in] dhcpv6Option A given DHCPv6 option
		 * @return A DhcpV6Option object containing the option data that comes next, or logical nullptr if the given
		 * DHCPv6 option: (1) was the last one; (2) contains a logical nullptr or (3) doesn't belong to this packet
		 */
		 ...
		 * @return A DhcpV6Option object containing the newly added DHCP option data or logical nullptr
		 ...
		 * @return A DhcpV6Option object containing the newly added DHCPv6 option data or logical nullptr
		 * (DhcpV6Option#isNull() == true) if addition failed
		 */
