...
protected: 
    ...
    /**
     * service id 0xffff and method id 0x8100 reserved for service discovery messages
     * @return true if message belongs to service discovery
     * @return false if not sd message
     */
    bool isSomeIpSd() {
        return (service_id == 65535 && method_id == 33024);
    }
...
public:
    ...
    /**
     * Looking up for the SOME/IP SD and returning @ref SomeIpSdLayer
     */
