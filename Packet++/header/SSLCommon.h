...
/**
 * @class SSLVersion
 * A wrapper class for SSL/TLS versions. The SSL/TLS version is typically
 * represented by a 2-byte number, for example TLS 1.2 is represented by 0x0303.
...
class SSLVersion {
   ...
   */
    ...
    /**
   * @return An enum value of type SSLVersion::SSLVersionEnum representing the
   * SSL/TLS version. If the numeric value is an invalid SSL/TLS version
   * SSLVersion::Unknown will be returned.
   * @param[in] countTlsDraftsAs1_3 A flag indicating whether to return the enum
   * value SSLVersion::TLS1_3 for all TLS 1.3 drafts. If set to "true" all
   * TLS 1.3 draft values (i.e 0x7f0e - 0x7f1c, 0xfb17, 0xfb1a) will return
   * SSLVersion::TLS1_3, otherwise the corresponding enum values will be
   ...
   */
    ...
    /**
   * @return A string representation of the SSL/TLS version. For example: for
   * TLS 1.2 the string "TLS 1.2" is returned. If the numeric value is an
   * invalid SSL/TLS version the string "Unknown" will be returned.
   * @param[in] countTlsDraftsAs1_3 A flag indicating whether to return the
   * string value "TLS 1.3" for all TLS 1.3 drafts. If set to "true" all TLS 1.3
   * draft values (i.e 0x7f0e - 0x7f1c, 0xfb17, 0xfb1a) will return "TLS 1.3",
   * otherwise the corresponding string values will be returned. The default
   * value is "false".
   */
