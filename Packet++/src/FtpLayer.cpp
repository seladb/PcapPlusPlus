...
std::string FtpRequestLayer::getCommandInfo(FtpCommand code)
{
    ...
    case FtpCommand::EPRT:
        return "Specifies an extended address and port to which the server should "
               "connect";
    ...
    case FtpCommand::HELP:
        return "Returns usage documentation on a command if specified, else a "
    ...
    case FtpCommand::LIST:
        return "Returns information of a file or directory if specified, else "
               "information of the current working "
               "directory is returned";
    case FtpCommand::LPRT:
        return "Specifies a long address and port to which the server should "
               "connect";
    ...
    case FtpCommand::MFF:
        return "Modify fact (the last modification time, creation time, UNIX "
    ...
    case FtpCommand::MLSD:
        return "Lists the contents of a directory in a standardized "
               "machine-readable format";
    case FtpCommand::MLST:
        return "Provides data about exactly the object named on its command line "
               "in a standardized "
               "machine-readable format";
    ...
    case FtpCommand::SITE:
        return "Sends site specific commands to remote server (like SITE IDLE 60 "
               "or SITE UMASK 002). Inspect SITE "
    ...
    case FtpCommand::SPSV:
        return "Use single port passive mode (only one TCP port number for both "
               "control connections and "
               "passive-mode data connections)";
    case FtpCommand::STAT:
        return "Returns information on the server status, including the status of "
