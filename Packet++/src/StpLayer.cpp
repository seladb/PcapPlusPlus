...
namespace pcpp
{
	...
	void StpTopologyChangeBPDULayer::doParseNextLayer(ParserConfiguration const& config)
	{
	...
	void StpConfigurationBPDULayer::doParseNextLayer(ParserConfiguration const& config)
	{
	...
	void RapidStpLayer::doParseNextLayer(ParserConfiguration const& config)
	{
