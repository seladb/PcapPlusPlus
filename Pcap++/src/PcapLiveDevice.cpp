...
std::unique_ptr<PcapLiveDevice> PcapLiveDevice::cloneInternal(pcap_if_t& devInterface) const
{
	return std::unique_ptr<PcapLiveDevice>(new PcapLiveDevice(&devInterface, true, true, true));
}
