...
bool WinPcapLiveDevice::startCapture(OnPacketArrivesCallback onPacketArrives,
                                     ...
                                     void* onStatsUpdateUserCookie)
{
    ...
    return PcapLiveDevice::startCapture(
        onPacketArrives, onPacketArrivesUserCookie,
        intervalInSecondsToUpdateStats, onStatsUpdate, onStatsUpdateUserCookie);
}
