...
std::unique_ptr<PcapLiveDevice> WinPcapLiveDevice::cloneInternal(pcap_if_t& devInterface) const
{
	return std::unique_ptr<WinPcapLiveDevice>(new WinPcapLiveDevice(&devInterface, true, true, true));
}
