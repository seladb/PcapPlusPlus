...
PcapRemoteDevice::PcapRemoteDevice(pcap_if_t* iface, const std::shared_ptr<PcapRemoteAuthentication>& remoteAuthentication, const IPAddress& remoteMachineIP, uint16_t remoteMachinePort)
