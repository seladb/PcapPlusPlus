...
namespace pcpp
{
	...
	public:
		 ...
		 * if this parameter isn't set or is set to an unspecified IPv4 address the default IPv4 address of the interface will be used
		 ...
		 * to log
		 */
		MacAddress getMacAddress(pcpp::experimental::IPv4Address ipAddr, PcapLiveDevice* device, double& arpResponseTimeMS,
				MacAddress sourceMac = MacAddress::Zero, pcpp::experimental::IPv4Address sourceIP = pcpp::experimental::IPv4Address(), int arpTimeout = -1) const;
		 ...
		 * written on the DNS response. If DNS response doesn't contain an IPv4 address resolving an unspecified IPv4 address will be returned.
		 ...
		 * is 5 sec
		 * @param[in] dnsServerIP An optional parameter to specify the DNS server IP to send the DNS request to. If this parameter is not set
		 * or is set to an unspecified IPv4 address the DNS request will be sent to the default DNS server configured in the system
		 * @param[in] gatewayIP An optional parameter to specify the LAN gateway to send the DNS request through. If this parameter is not set
		 * or is set to an unspecified IPv4 address the interface's default gateway will be used
		 ...
		 */
		pcpp::experimental::IPv4Address getIPv4Address(std::string hostname, PcapLiveDevice* device, double& dnsResponseTimeMS, uint32_t& dnsTTL,
				int dnsTimeout = -1, pcpp::experimental::IPv4Address dnsServerIP = pcpp::experimental::IPv4Address(), pcpp::experimental::IPv4Address gatewayIP = pcpp::experimental::IPv4Address()) const;
