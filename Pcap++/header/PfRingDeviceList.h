 ...
 * A singleton class that holds all available PF_RING devices. Through this
...
class PfRingDeviceList
{
   ...
   */
    ...
    /**
   * Get a PF_RING device by name. The name is the Linux interface name which
   * appears in ifconfig (e.g eth0, eth1, etc.)
