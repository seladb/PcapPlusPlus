...
namespace pcpp
{
	...
	private:
		...
		PcapRemoteDevice(pcap_if_t* iface, PcapRemoteAuthentication* remoteAuthentication, const pcpp::experimental::IPAddress& remoteMachineIP, uint16_t remoteMachinePort);
