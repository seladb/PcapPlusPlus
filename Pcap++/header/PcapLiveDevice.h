...
typedef void (*OnPacketArrivesCallback)(RawPacket* pPacket,
		PcapLiveDevice* pDevice, void* userCookie);
...
typedef bool (*OnPacketArrivesStopBlocking)(RawPacket* pPacket,
		PcapLiveDevice* pDevice, void* userData);
...
public:
	 ...
	 */
	virtual inline uint16_t getMtu() {
		return m_DeviceMtu;
	}
	 ...
	 */
	inline std::vector<pcap_addr_t>& getAddresses() {
		return m_Addresses;
	}
	 ...
	 */
	virtual inline MacAddress getMacAddress() {
		return m_MacAddress;
	}
	 ...
	 */
	virtual bool startCapture(OnPacketArrivesCallback onPacketArrives,
			void* onPacketArrivesUserCookie, int intervalInSecondsToUpdateStats,
			OnStatsUpdateCallback onStatsUpdate, void* onStatsUpdateUserCookie);
	 ...
	 */
	virtual int startCaptureBlockingMode(
