 ...
 * An abstract interface representing all devices that have BPF (Berkeley Packet
 * Filter) filtering capabilities, meaning devices that can filter packets based
...
class IFilterableDevice {
   ...
   * that match the filter will be received
   * @param[in] filter The filter to be set in PcapPlusPlus' GeneralFilter
   * format
