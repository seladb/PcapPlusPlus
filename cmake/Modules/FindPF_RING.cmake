...
set(PF_RING_INCLUDE_DIRS ${PF_RING_KERNEL_INCLUDE_DIR}
                         ${PF_RING_USER_INCLUDE_DIR})

if(PF_RING_FOUND AND NOT TARGET PF_RING::PF_RING)
  add_library(PF_RING::PF_RING INTERFACE IMPORTED)
  set_property(TARGET PF_RING::PF_RING PROPERTY INTERFACE_LINK_LIBRARIES
                                                "${PF_RING_LIBRARIES}")
  set_property(TARGET PF_RING::PF_RING PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                                                "${PF_RING_INCLUDE_DIRS}")
endif()
